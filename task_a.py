...
class GeneratePDDL_Stationary :
    ...
    def generateInitString(self) :
        ...
        agent_string += "(at " + "agent1 "+"pt{}pt{}".format(agent_x, agent_y)+") "
        ...
        for car in self.state.cars:
            ...
            blocked_string += "(blocked " +"pt{}pt{}".format(car_x, car_y)+") "

        predicate_string = ''
        for w in range(self.width-1, 0, -1):
            for lane in range(self.num_lanes):
        
                predicate_string += "(forward_next " +"pt{}pt{}".format(w, lane)+ " " +"pt{}pt{}".format(w-1, lane)+") "
                if lane < self.num_lanes-1:
                    predicate_string += "(down_next " +"pt{}pt{}".format(w, lane)+ " " +"pt{}pt{}".format(w-1, lane+1)+") "
                if lane > 0:
                    predicate_string += "(up_next " +"pt{}pt{}".format(w, lane)+ " " +"pt{}pt{}".format(w-1, lane-1)+") "
    ...
    def generateGoalString(self) :
        ...
        finish_string += "(at " + "agent1 "+"pt{}pt{}".format(finish_x, finish_y)+")"
